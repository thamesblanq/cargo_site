  ...
  return (
    <div className="md:hidden flex flex-col gap-4 bg-gray-500 absolute top-0 w-full h-full px-4 mx-auto z-50">
        ...
        <nav className="flex flex-col gap-4 mt-16 items-center">
            <ul><li className="dark:text-white cursor-pointer hover:font-bold">About</li></ul>
            <ul><li className="dark:text-white cursor-pointer hover:font-bold">Service</li></ul>
            <ul><li className="dark:text-white cursor-pointer hover:font-bold">Contact</li></ul>
        </nav>
        <button className="p-4 bg-gray-900 rounded-xl  text-white font-semibold text-xl">Login</button>
    </div>
  )
}
