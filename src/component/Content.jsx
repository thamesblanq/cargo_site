  ...
  return (
    <main className='w-full bg-white py-8'>
      ...
      <section className='w-full px-4 mt-24'>
        <div className='grid grid-cols-2 md:grid-cols-3 gap-16 md:w-[80%] mx-auto place-content-center'>

          <div className='flex items-center justify-center flex-col border border-black rounded-lg p-8'>
            <h1 className='text-primary font-bold text-2xl mb-2 font-poppins'>What makes us stand out</h1>
            <p className='text-xl mb-2 font-poppins'>Here are few reasons why you should opt for our services ahead of others.</p>
            <button className='text-[#5A57FF] flex justify-around items-center p-4 border-2 gap-2 rounded-lg border-[#5A57FF] hover:translate-y-3 duration-500 ease-in-out'>Read More<FaBook /></button>
          </div>
          ...
          <div className='shadow-2xl rounded-lg hover:translate-x-3 hover:-translate-y-6 duration-500 ease-in-out object-cover grayscale hover:grayscale-0 cursor-pointer'>
            ...
            <h5 className='font-bold text-primary font-poppins text-2xl mx-4 md:my-4 my-2'>Easy Booking Process</h5>
            <p className='text-gray-500 font-poppins text-sm md:text-xl mb-4 mx-4'>Our user-friendly platform lets you book deliveries effortlessly, saving you time and hassle.</p>
          </div>
          ...
          <div className='shadow-2xl rounded-lg hover:translate-x-3 hover:-translate-y-6 duration-500 ease-in-out object-cover grayscale hover:grayscale-0 cursor-pointer'>
            ...
            <h5 className='font-bold text-primary font-poppins text-2xl mx-4 md:my-4 my-2'>Dedicated Support</h5>
            <p className='text-gray-500 font-poppins text-sm md:text-xl mb-4 mx-4'>Our team is here to assist you at every step, providing reliable and responsive customer support.</p>
          </div>
          ...
          <div className='shadow-2xl rounded-lg hover:translate-x-3 hover:-translate-y-6 duration-500 ease-in-out object-cover grayscale hover:grayscale-0 cursor-pointer'>
            ...
            <h5 className='font-bold text-primary font-poppins text-2xl mx-4 md:my-4 my-2'>Speedy Deliveries</h5>
            <p className='text-gray-500 font-poppins text-sm md:text-xl mb-4 mx-4'>Fast and efficient service ensures your packages reach their destination on time, every time.</p>
          </div>
          ...
          <div className='shadow-2xl rounded-lg hover:translate-x-3 hover:-translate-y-6 duration-500 ease-in-out object-cover grayscale hover:grayscale-0 cursor-pointer'>
            ...
            <h5 className='font-bold text-primary font-poppins text-2xl mx-4 md:my-4 my-2'>Reliable Tracking</h5>
            <p className='text-gray-500 font-poppins text-sm md:text-xl mb-4 mx-4'>Stay updated with precise tracking, ensuring you always know where your package is.</p>
          </div>
          ...
          <div className='shadow-2xl rounded-lg hover:translate-x-3 hover:-translate-y-6 duration-500 ease-in-out object-cover grayscale hover:grayscale-0 cursor-pointer'>
            ...
            <h5 className='font-bold text-primary font-poppins text-2xl mx-4 md:my-4 my-2'>Secure Handling</h5>
            <p className='text-gray-500 font-poppins text-sm md:text-xl mb-4 mx-4'>We prioritize the safety of your shipments with meticulous handling and protective measures.</p>
          </div>
